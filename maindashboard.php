<?php include './source_file/thempart/dashboardcss.php'; ?>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="source_file/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60"
                width="60">
        </div>
        <?php include './source_file/thempart/header.php'; ?>

        <?php include './source_file/thempart/sidebar.php' ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="source_file/dist/img/user1-128x128.jpg"
                                        ...
                                        <div class="direct-chat-msg right">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="source_file/dist/img/user3-128x128.jpg"
                                                alt="message user image">
                                            <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="source_file/dist/img/user1-128x128.jpg" alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="source_file/dist/img/user7-128x128.jpg" alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="source_file/dist/img/user3-128x128.jpg" alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="source_file/dist/img/user5-128x128.jpg" alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="source_file/dist/img/user6-128x128.jpg" alt="User Avatar">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img"
                                                        src="source_file/dist/img/user8-128x128.jpg" alt="User Avatar">
        ...
        <!-- /.content-wrapper -->
        <?php include './source_file/thempart/footer.php' ?>
    ...
    <!-- jQuery -->
    <?php include './source_file/thempart/dashboardjs.php'; ?>
